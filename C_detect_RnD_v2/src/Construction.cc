...
G4VPhysicalVolume* MyDetectorConstruction::Construct()
{
  ...
  */
  ...
  G4double Guide_Height = 0.01*mm;

  G4Cons * Guide_Sol_Plus = new G4Cons("LAB_Guide_Plus",
				  Guide_Axial,
				  Guide_Up_R,
				  Guide_Axial,
				  Guide_Down_R,
    ...
    G4Cons * Guide_Sol_Minus = new G4Cons("LAB_Guide_Minus",
				  Guide_Axial,
				  Guide_Down_R,
				  Guide_Axial,
				  Guide_Up_R,
  ...
  G4UnionSolid* Union_LS_Sol_temp = new G4UnionSolid("Union_LS_Sol_temp",
                  LS_Sol,
                  Guide_Sol_Plus,
                  0,
                  G4ThreeVector(0,0,(LS_height+Guide_Height)*0.5));
  ...
  G4VPhysicalVolume* Union_LS_Phys = new G4PVPlacement(0,
		    G4ThreeVector(0., 0., 0.),
		    Union_LS_Log,
		    "Union_LS_Phys",
		    teflonLog,  
  ...
  */
  ...
  for(G4int i=0; i<2; i++)
    {
      PMT_pos_z=(Guide_Height*2.+LS_height+PMT_height)*0.5*(2*i-1);     
